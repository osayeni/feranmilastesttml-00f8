[feranmilastesttml-00f8] Operating Details
====================================

Generated On: 2024-10-17 21:08:01 UTC
...
.. important::
   ...
   **not be valid if your [feranmilastesttml-00f8] container is NOT running**.

.. tip::
   You must have your [feranmilastesttml-00f8] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/osayeni/samuel  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=33809  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='osayeni'  \-\-env DOCKERUSERNAME='osayeni'  \-\-env MQTTUSERNAME='osayeni'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   osayeni/feranmilastesttml-00f8-amd64 (https://hub.docker.com/r/osayeni/feranmilastesttml-00f8-amd64)
...
.. important::
   docker run -d -p 45047:45047 -p 39483:39483 -p 48237:48237 \-\-env TSS=0 \-\-env SOLUTIONNAME=feranmilastesttml-00f8 \-\-env SOLUTIONDAG=solution_preprocessing_dag-feranmilastesttml-00f8 \-\-env GITUSERNAME=osayeni  \-\-env GITREPOURL=https://github.com/osayeni/samuel \-\-env SOLUTIONEXTERNALPORT=45047  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=39483  \-\-env SOLUTIONVIPERVIZPORT=48237 \-\-env DOCKERUSERNAME='osayeni'  \-\-env EXTERNALPORT=33809 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='osayeni' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  osayeni/feranmilastesttml-00f8-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=48237
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=45047
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - osayeni/feranmilastesttml-00f8-amd64
...
It can be accessed by entering: http://localhost:39483
...
.. important::
   http://localhost:48237/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:48237/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:48237/<html file>
...
[feranmilastesttml-00f8] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/osayeni/samuel/tree/main/tml-airflow/dags/tml-solutions/feranmilastesttml-00f8
...
.. important::
   https://feranmilastesttml-00f8.readthedocs.io
...
.. important::
   solution_preprocessing_dag-feranmilastesttml-00f8
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=45047, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=41113, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38007, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=43911, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34773, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36459, HPDEHOST=127.0.1.1, HPDEPORT=39207, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=43367

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-5043-feranmilastesttml-00f8,solution_preprocessing_dag-feranmilastesttml-00f8, python-preprocess-3754-feranmilastesttml-00f8,solution_preprocessing_dag-feranmilastesttml-00f8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
